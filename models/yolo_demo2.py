...
from models.common_demo import Conv, Bottleneck, SPP, DWConv, Focus, BottleneckCSP, C3, ShuffleV2Block, Concat, NMS, autoShape, StemBlock, BlazeBlock, DoubleBlazeBlock
        ...
        if self.export_cat:
            for i in range(self.nl):
                ...
                # x[i] = x[i].view(bs, self.na, self.no, ny, nx).permute(0, 1, 3, 4, 2).contiguous()
                    ...
                    print(y.shape)
                    print(" y  ", y.detach().cpu().numpy()[ 0, 0, 0, :10])
